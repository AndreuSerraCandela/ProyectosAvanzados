tableextension 50319 "Vendor Ledger Entry Ext" extends "Vendor Ledger Entry"
{
    ...
    //                 JobLedgerEntry.SetRange("Vendor No.", VendorLedgerEntry."Vendor No.");
    //                 if JobLedgerEntry.FindSet() then begin
    //                     JobLedgerEntry.CalcSums(Amount, "Base Amount");
    //                     TotalInvoiceAmount := JobLedgerEntry.Amount;
    //                     TotalAmount := JobLedgerEntry."Base Amount";
    //                 end;
