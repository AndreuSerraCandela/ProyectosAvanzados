/// <summary>
/// Libro de facturas emitidas (ventas) por pantalla, exportable a Excel
/// con una hoja por Tipo de Operación2.
/// </summary>
page 50348 "Libro Facturas Emitidas"
{
    ApplicationArea = All;
    ...
    actions
    {
        area(Processing)
        {
            action(Actualizar)
            {
                ...
                Caption = 'Actualizar';
                Image = Refresh;
                ToolTip = 'Carga los movimientos de IVA de venta del período indicado.';
                trigger OnAction()
                begin
                    Cargar();
                end;
            ...
            action(ExportarExcel)
            {
                ...
                begin
                    LibroIVA.ExportarExcel(Rec, 'Libro Facturas Emitidas');
                end;
            }
        }
        area(Promoted)
    ...
    begin
        LibroIVA.CargarLibro(Rec, VATEntry.Type::Sale, FechaDesde, FechaHasta);
